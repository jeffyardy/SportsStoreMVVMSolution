namespace SportStoreDomainLibrary.DataContexts.SportsStoreMigrations
{
    using System;
  ...
  using SportStoreDomainLibrary.Entities;
    internal sealed class Configuration : DbMigrationsConfiguration<SportStoreDomainLibrary.Concrete.SportsStoreDbContext>
    {
        ...
        protected override void Seed(SportStoreDomainLibrary.Concrete.SportsStoreDbContext context)
        {
